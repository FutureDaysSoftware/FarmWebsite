const Request = Object.assign({}, require('./MyObject'), {
    ...
    request() {
        return new Promise((resolve, reject) => {
            const protocol =
                    this.opts.protocol && this.opts.protocol === 'https'
                        ? this.Https
                        : this.Http,
...
module.exports = opts =>
    Object.create(Request, { opts: { value: opts } }).constructor()
